...
if __name__ == "__main__":
    ...
    parser.add_argument("--cache-dir", type=str, default="/kaggle/working/grouping/result.json", help="Directory to cache grouping result.")
